...
public class DisplayProductsActivity extends AppCompatActivity {
    ...
    TextView tv_rating, product_name, Product_price,
            Product_discount, Product_brand,
            Product_pieces, Product_description;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 🔥 SAFE INTENT HANDLING (NO FLAG NEEDED)
        Intent intent = getIntent();

        int product_id = intent.getIntExtra(HomeActivity.PRODUCT_KEY,
                intent.getIntExtra(ProductsCardActivity.PRODUCT_ID_KEY, -1));

        String table_name = intent.getStringExtra(HomeActivity.TABLE_NAME_KEY);
        ...
        // 🔥 Safety check
        if (product_id == -1 || table_name == null) {
        ...
        if (p.getDiscount() > 0) {
            ...
            Product_price.setPaintFlags(
                    Product_price.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
        ...
        add_to_cart.setOnClickListener(view -> {
            ...
            Products cartProduct =
                    new Products(image, name, priceAfter, brand, rating, quantity);

            AlertDialog alertDialog =
                    new AlertDialog.Builder(DisplayProductsActivity.this).create();
            ...
            alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "Ok",
                    (dialogInterface, i) -> {
                        ...
                        db.insertProductInPurchases(cartProduct);
                        Toast.makeText(DisplayProductsActivity.this,
